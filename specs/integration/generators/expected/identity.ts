...
export type System0 = {
  Coord: FinitioTypes.Type<FinitioInputs._Coord, Coord>;
  Either: FinitioTypes.Type<FinitioInputs._Either, Either>;
  Main: FinitioTypes.Type<FinitioInputs._Main, Main>;
};
/**
 * An ADT with no `.JsType` preamble: every contract is an identity, and the
 * value is simply its information type
 */
export type Coord = [number, number];
/** Several identity contracts make a union */
export type Either = FinitioImports.Data.String | FinitioImports.Data.Numeric;
export type Main = {
  c: Coord;
  e: Either;
};
export namespace FinitioInputs {
   ...
   * value is simply its information type
   */
  export type _Coord = [number, number];
  /** Several identity contracts make a union */
  export type _Either = FinitioImports.Data.FinitioInputs._String | FinitioImports.Data.FinitioInputs._Numeric;
  export type _Main = {
    c: FinitioInputs._Coord;
    e: FinitioInputs._Either;
  };
}
...
export default (() => {
  ...
  return (
    ...
    return world.importResolver!('file://specs/integration/generators/fixtures/identity.fio', world, options) as unknown as FinitioTypes.System<System0>;
  };
})();
