...
export type System0 = {
  ...
  Priority: FinitioTypes.Type<FinitioInputs._Priority, Priority>;
  Flag: FinitioTypes.Type<FinitioInputs._Flag, Flag>;
  Falsy: FinitioTypes.Type<FinitioInputs._Falsy, Falsy>;
  Ranged: FinitioTypes.Type<FinitioInputs._Ranged, Ranged>;
...
/** Falsy members are members like any other */
export type Falsy = 0 | false | "";
/** A set of non scalars stays its super type */
export type Ranged = FinitioImports.Data.Integer;
export type Main = {
  colour: Colour;
  priority: Priority;
  flag: Flag;
...
export namespace FinitioInputs {
  /** The colours we support */
  export type _Colour = "red" | "green" | "blue";
  export type _Priority = 0 | 1 | 2;
  export type _Flag = true;
  /** Falsy members are members like any other */
  export type _Falsy = 0 | false | "";
  /** A set of non scalars stays its super type */
  export type _Ranged = FinitioImports.Data.FinitioInputs._Integer;
  export type _Main = {
    colour: FinitioInputs._Colour;
    priority: FinitioInputs._Priority;
    flag: FinitioInputs._Flag;
    falsy: FinitioInputs._Falsy;
    ranged: FinitioInputs._Ranged;
  };
}
...
export default (() => {
  ...
  return (
    ...
    return world.importResolver!('file://specs/integration/generators/fixtures/literals.fio', world, options) as unknown as FinitioTypes.System<System0>;
  };
})();
