...
/** A released piece of software */
export type Main = {
  name: FinitioImports.Data.String;
  version: FinitioImports.Data.String;
  releasedAt: FinitioImports.Data.Date;
};
export namespace FinitioInputs {
  /** A released piece of software */
  export type _Main = {
    name: FinitioImports.Data.FinitioInputs._String;
    version: FinitioImports.Data.FinitioInputs._String;
    releasedAt: FinitioImports.Data.FinitioInputs._Date;
  };
}
...
export default (() => {
  ...
  return (
    ...
    return world.importResolver!('file://specs/integration/generators/fixtures/simple.fio', world, options) as unknown as FinitioTypes.System<System0>;
  };
})();
