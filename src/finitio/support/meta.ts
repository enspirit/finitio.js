  ...
  contracts: [
    Contract.info({
      ...
      explicit: {
        ...
        undress: function(_allowExtra, _world) {
          // TODO
...
Meta.Contract.Explicit = contract('Explicit', ExplicitContract, [
  Attribute.info({
    name: 'explicit',
    type: TupleType.info({
      heading: Heading.info({
...
Meta.Contract.Internal = contract('Internal', InternalContract, [
  Attribute.info({ name: 'internal', type: Js.Type }),
]);

Meta.Contract.External = contract('External', ExternalContract, [
  Attribute.info({ name: 'external', type: Js.Type }),
]);

Meta.Contract.Identity = contract('Identity', IdentityContract, [
...
Meta.Constraint.Native = constraint('Native', NativeConstraint, [
  Attribute.info({ name: 'native', type: Js.Function }),
]);

Meta.Constraint.Regexp = constraint('RegExp', RegexpConstraint, [
...
Meta.Constraint.Range = constraint('Range', RangeConstraint, [
  Attribute.info({ name: 'range', type: Meta.Range }),
]);

Meta.Constraint.Set = constraint('Set', SetConstraint, [
